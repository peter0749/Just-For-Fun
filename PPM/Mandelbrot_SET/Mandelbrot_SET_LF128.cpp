...
inline __float128 dist(const __float128 a, const __float128 b)
{
	return a*a+b*b;
}
...
int main(void)
{
	...
	__float128 scalex, scaley, enterx, entery;
	__float128 R,I,nR,nI,tR,tI;
	__float128 r, a, tsin,tcos, tcot, A, k;
	__float128 ERR, chcl;
	char temp[MAX];
	COLOR col, si;
	srand(time(NULL));
